...
<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
    <div class="card card-signin my-5">
        <div class="card-body">
              ...
              <h5 class="card-title text-center">Registrar fabricante</h5>
              <form class="form-signin" action="register_manufacturer.php" method="POST">

                <div class="form-label-group">
                  <input type="text" id="usuario" name="manufacturer" class="form-control" placeholder="Fabricante" autofocus>
                  <label for="usuario">Fabricante</label>
