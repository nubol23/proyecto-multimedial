...
<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
    <div class="card card-signin my-5">
        <div class="card-body">
              ...
              <h5 class="card-title text-center">Registrar medicamento</h5>
              <form class="form-signin" action="register_medicine.php" method="POST">

                <div class="form-label-group">
                  <input type="text" id="usuario" name="medicine" class="form-control" placeholder="Medicina" autofocus>
                  <label for="usuario">Medicina</label>
                    <span class="help-block message">
                        <?php
                            if(isset($_COOKIE['medicine_error'])) {
                                echo $_COOKIE['medicine_error'];
                            } else {
                                echo "";
                            }
                        ?>
                ...
                <div class="form-label-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                  ...
                  <label for="price">Precio</label>
                    <span class="help-block message">
                        <?php
                            if(isset($_COOKIE['medicine_price_error'])) {
                                echo $_COOKIE['medicine_price_error'];
                            } else {
                                echo "";
                            }
                        ?>
                ...
                <div class="form-label-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                  <select id="price" name="manufacturer" class="form-control" placeholder="Fabricante">
                  <?php
                            $arr = get_all_medicines_and_manufacturers();
                            $manufacturer_names = $arr['manufacturer_names'];
                            foreach($manufacturer_names as $value) {
